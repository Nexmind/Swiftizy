...
public class Creating {
     ...
     */
    public func entity(entity: AnyClass) -> NSManagedObject{
        ...
        let entity = NSEntityDescription.entity(forEntityName: NSStringFromClass(entity).pathExtension, in: managedContext)
    ...
    public func exceptIfStringMatch(entity: AnyClass, attributeName: String, attributeValue: String) -> NSManagedObject? {
        ...
        if results.count == 0 {
            return self.entity(entity: entity)
        }
        return nil
    }
